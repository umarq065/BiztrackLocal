...
export function PerformanceRadialChart({
  ...
  return (
    <Card className="flex flex-col h-full border-border bg-card backdrop-blur-md">
      <CardHeader>
        <CardTitle className="text-card-foreground">Performance</CardTitle>
        <CardDescription className="text-muted-foreground">Your progress towards your monthly revenue target.</CardDescription>
      </CardHeader>
        ...
        <div className="w-[140px]">
          <div className="relative h-[140px]">
            ...
            <div className="absolute top-1/2 left-1/2 flex -translate-x-1/2 -translate-y-1/2 flex-col items-center justify-center text-center">
              <p className="text-3xl font-bold text-foreground drop-shadow-md">{`${Math.round(
                performance
              )}%`}</p>
            </div>
          </div>
